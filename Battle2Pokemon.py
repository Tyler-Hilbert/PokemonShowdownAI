...
class Pokemon:
    ...
    def outcomeDefending(self, attackingPokemon):
        ...
        # FIXME - is there another comparision
        print (s)
...
allyPkmn = Pokemon(pokedex.findPokemonUsingName(allyPkmnName)['name'], pokedex.findPokemonUsingName(allyPkmnName)['types'], allyWeakAgainst) # FIXME - Pokemon Loading
foePkmn = Pokemon(pokedex.findPokemonUsingName(foePkmnName)['name'], pokedex.findPokemonUsingName(foePkmnName)['types'], foeWeakAgainst) # FIXME - Pokemon Loading
